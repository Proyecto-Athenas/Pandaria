...
MySQL - 5.7.38-log : Database - test_mop_auth
*********************************************************************
*/
...
insert  into `bonus_rates`(`id`,`realmid`,`active`,`schedule`,`multiplier`,`rates`,`start_announcement`,`end_announcement`,`active_announcement`) values 
(1,1,1,'* * * * 5;* * * * 6;* * * * 7',2,'Rate.XP.Kill Rate.XP.Quest Rate.XP.Explore Rate.Reputation.Gain Rate.Reputation.LowLevel.Kill SkillGain.Crafting SkillGain.Gathering Rate.Drop.Money','Weekend Bonus Bonus Start','Weekend Bonus Bonus End','Weekend Bonus is Active');
...
('Battlegrounds','Battleground.Rewards.Enabled','0','1',1,NULL,NULL),
('Rate','BonusRoll.LootChance','31','31',1,'Bonus Roll',NULL),
('Battlegrounds','ICore.RichPvPRewards.Enabled','0','1',1,NULL,NULL),
('LFR','LFR.LootChance','20','20',-1,'Chance to get personal loot from any boss',NULL),
('Custom','ShowInfoPlayer.ban','-1','0',1,NULL,NULL),
('Custom','ShowInfoPlayer.kick','-1','0',1,NULL,NULL),
('Custom','ShowInfoPlayer.mute','-1','0',1,NULL,NULL),
...
CREATE TABLE `realmlist` (
  ...
  `gamebuild` int(11) unsigned NOT NULL DEFAULT '18414',
...
(1,'MoP','MoP','144.217.255.200',8085,0,2,0,0,0,18414,32,0,1,'db_char','db_world','db_archive',0,0,80,'IGNORE','IGNORE','IGNORE','IGNORE',0,'0','0',1,0,0,0);
