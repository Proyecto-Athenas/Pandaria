...
MySQL - 5.7.38-log : Database - test_mop_char
*********************************************************************
*/
...
/*Table structure for table `promo_boost` */

DROP TABLE IF EXISTS `promo_boost`;

CREATE TABLE `promo_boost` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `account` int(10) DEFAULT NULL,
  `ip_account` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `promo_boost` */

LOCK TABLES `promo_boost` WRITE;
