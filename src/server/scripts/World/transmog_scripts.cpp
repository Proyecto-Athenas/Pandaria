...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        if ((player->GetQuestStatus(40328) == QUEST_STATUS_REWARDED || player->GetQuestStatus(40329) == QUEST_STATUS_REWARDED) || !sConfigMgr->GetBoolDefault("Transmogrification.RequiredQuest", true))
        {
